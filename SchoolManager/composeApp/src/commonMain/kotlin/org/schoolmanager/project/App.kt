...
import org.schoolmanager.project.ui.syllabus.ResumeOrderScreen
            ...
            Scaffold(
                ...
                when (SelectedScreen) {
                    ...
                    "CartSyllabus" -> CartSyllabusScreen(
                        ...
                        GoToResumeOrder = { SelectedScreen = "ResumeOrder" },
                        syllabusviewModel = SyllabusViewModel()
                    )
                    "ResumeOrder" -> ResumeOrderScreen(
                        BackCart = { SelectedScreen = "CartSyllabus" },
                        GoToHomeSyllabus = { SelectedScreen = "HomeSyllabus" },
                        syllabusviewModel = SyllabusViewModel()
                    )
