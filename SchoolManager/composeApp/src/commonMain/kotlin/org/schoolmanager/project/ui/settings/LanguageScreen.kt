...
fun LanguageScreen(BackSettings: () -> Unit) {
    Column( // Use Column to stack the elements vertically
        ...
        Text(
            "This app is available in the following languages: French, English, Spanish, and Dutch. To switch to one of these languages, select the desired language in your device's settings.",
            fontSize = 16.sp,
            lineHeight = 24.sp, // Increase line height for better readability
            modifier = Modifier
                .fillMaxWidth()
                .padding(horizontal = 16.dp, vertical = 8.dp), // Add some padding to avoid text being too close to the edges
            color = MaterialTheme.colors.onBackground // Using theme colors for text
        )

        // You can uncomment and use these for the language selection cards later
        // LanguageCard("English")
        // LanguageCard("Français")
        // LanguageCard("Nederlands")
